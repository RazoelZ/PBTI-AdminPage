...
const UKTCard = ({ cabangdojang, nomorPengajuan, lokasiUjian, tanggalPelaksanaan }) => {
    const navigate = useNavigate();

    const handleDetailClick = () => {
        navigate('/detail-pengajuan', {
    ...
    return (
        <>
            ...
            <div className="text-xs grid grid-cols-1 gap-y-2 md:text-base lg:text-lg mt-2">
            ...
            <button
                className="w-full font-semibold py-2 px-4 border-2 border-black rounded-md mt-4"
